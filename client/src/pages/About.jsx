...
import { teamMembers, techStack } from "../constants/aboutData";
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center lg:items-start gap-6 sm:gap-8 mb-16 md:mb-20">
          {teamMembers.map((member) => {
            ...
            return (
              ...
              >
                <div
                  className={`bg-white rounded-2xl shadow-xl overflow-hidden transform transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl h-full flex flex-col ${
                    isTeamLead
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center -mb-16">
                      <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-full border-4 border-white shadow-xl overflow-hidden mt-6 sm:mt-8">
                        <img
                          src={member.image}
                          alt={member.name}
        ...
        <div className="bg-white rounded-2xl shadow-xl p-5 sm:p-6 md:p-8 mb-10 sm:mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-10">
            {techStack.map((tech, index) => (
              <div key={index} className="flex flex-col items-center group cursor-pointer">
                <div
                  className={`w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 rounded-2xl flex items-center justify-center ${tech.color} shadow-lg group-hover:shadow-xl transform transition-all duration-300 group-hover:scale-110 mb-3 sm:mb-4`}
                >
                  {tech.icon}
                </div>
          ...
          <div className="mt-8 sm:mt-10 md:mt-12 text-center">
            <div className="inline-flex flex-wrap items-center justify-center px-4 py-2 sm:px-6 sm:py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full gap-2">
              ...
              <span className="ml-2 sm:ml-3 text-white font-semibold text-sm sm:text-base">
