...
import { Edit, Locate, Share, Zap } from "lucide-react";
    ...
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center">
        <img
          ...
          alt="Vehicle tracking features overview"
        />
        <div
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600 max-w-xs">
                  Track vehicles in real-time with accurate GPS updates and map visualization.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
            <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600 max-w-xs">
                  All user and vehicle data is securely encrypted to ensure privacy and safety.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
            <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-600 max-w-xs">
                  Easily share your vehicle’s live location via WhatsApp, Instagram, or other platforms.
                </p>
              </div>
            </div>
          </div>
