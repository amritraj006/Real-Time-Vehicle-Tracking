...
const Testimonial = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            ...
            <p className="text-sm py-4 text-gray-800">Creating this Real-Time Vehicle Tracker made live vehicle monitoring incredibly seamless.</p>
  ...
  return (
    <>
     <div id='testimonial' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title='Dont just take our words ' 
        description='Hear what our users say about us. We re always looking for ways to improve. If you have a positive experience, please let us know!' />
