  ...
  return (
    <>
     <style>{`
            ...
            <footer className="mt-40 flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/60 to-white ">
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                        ...
                        <a href="https://www.linkedin.com/in/amrit-raj-54652b294/" target="_blank" rel="noreferrer">
                        ...
                        <a href="https://youtube.com/@amritraj7243?si=zKN0qfOTqlfLPrys" target="_blank" rel="noreferrer">
                    ...
                    <p className="mt-3 text-center">© 2025 Vehicle Tracker</p>
                </div>
            </footer>
    </>
  )
